    ...
    return (
        <div style={{ backgroundColor: '#ffffff' }}>
            <div style={{ textAlign: 'center', padding: '10px 0' }}>
                {/* Logotyp i headern med länk till startsidan, centrerar innehållet och lägger till padding */}
                <Link to="/start">
                    <img src="logovit.png" alt="Logotyp" style={{ maxWidth: '150px', height: 'auto' }} />
                </Link>
            </div>
            <Navbar expand="lg" style={{ backgroundColor: '#146F41', height: '40px', padding: '0 20px' }}>
                {/* Navbar från React-Bootstrap */}
                <Container>
                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        <Nav style={{ width: '100%', justifyContent: 'space-evenly', alignItems: 'center' }}>
                            ...
                            >
                                <FontAwesomeIcon icon={faRightToBracket} alt="inloggning" style={{ marginRight: '8px' }} />
                                INLOGGNING
                            </Nav.Link>
                            <Nav.Link
                                as={Link}
                            ...
                            <Nav.Link
                                ...
                                style={{ color: 'white', padding: '10px 20px' }}
                            >
                                <FontAwesomeIcon icon={faEnvelope} alt="brev" style={{ marginRight: '8px' }} />
                                KONTAKT | OM OSS
                            </Nav.Link>
                        </Nav>
                    </Navbar.Collapse>
